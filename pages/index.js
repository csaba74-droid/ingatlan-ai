        ...
        <div style={{ width: '100%', maxWidth: 680 }}>
          ...
          <div style={{
            ...
            <div style={{ background: '#1C2B3A', padding: '18px 24px', display: 'flex', alignItems: 'center', gap: 14, flexShrink: 0 }}>
              ...
              <div style={{ flex: 1 }}>
                <div style={{ fontFamily: "'DM Serif Display', serif", fontSize: 17, color: '#fff', letterSpacing: -0.3 }}>Virtuális asszisztens</div>
              ...
              <div style={{ display: 'flex', gap: 10, alignItems: 'flex-end' }}>
                ...
                <div style={{ maxWidth: '80%' }}>
                  <div style={{ background: '#f7f8fa', border: '0.5px solid rgba(28,43,58,0.10)', borderRadius: '4px 18px 18px 18px', padding: '11px 15px', fontSize: 14, lineHeight: 1.6, color: '#1C2B3A' }}>
                    Üdvözlöm! Az iroda virtuális asszisztense vagyok. Írja le elképzelését milyen ingatlant keres — akár olyan szempontokat is, amelyekre a hagyományos szűrőkben nem lehet keresni.
Például:
„Budapesten keresünk legalább 2 szobás világos lakást, lehetőleg csendes környéken. Fontos, hogy ne konvektoros legyen, előny a felújított épület és az iskola közelsége. A keretünk körülbelül 60 millió forint.”
                  </div>
                </div>
              </div>
